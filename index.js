...
//app = express();
const MONGO_URI = 'mongodb+srv://jiwachhmehta2:<>@mongo-db.bjvyj.mongodb.net/'; mongoose.connect(MONGO_URI, { useUnifiedTopology: true, useNewUrlParser: true }); const db = mongoose.connection;
